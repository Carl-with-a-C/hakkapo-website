...
import jumpingVectorBg from "../Multimedia/Vectors/bg.svg";
import jumpingVectorFg from "../Multimedia/Vectors/fg.svg";
      ...
      <div className="blurb-container">
        ...
        <div className="blurb--subtitle">
          <p>
            ...
            Nunc lobortis mattis aliquam faucibus purus in. Cursus metus aliquam{" "}
          </p>
        </div>
      </div>
